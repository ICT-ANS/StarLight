...
C.cache_dir = osp.join(C.work_dir, "data/LightweightComputing_Cache/nas.classification.ddsas") #checkpoint data log ....
C.current_dir = osp.join(C.work_dir, "nas", "classification_ddsas")
C.html_dir = osp.join(C.work_dir, "html", "nas", "classification_ddsas")
