...
import numpy as np
import torch
import nas.classification_sampled.models.snas.utils as utils
import logging
import argparse
...
parser.add_argument('--arch', type=str, default='SNAS_mine', help='which architecture to use')
...
#logger = tensorboardX.SummaryWriter(os.path.join(args.save, 'tensorboardX'))

def model_vis():
  genotype = eval("genotypes.%s" % args.arch)
  model_vis = Network(args.init_channels, CIFAR_CLASSES, args.layers, args.auxiliary, genotype)
  model_vis.drop_path_prob = args.drop_path_prob  / args.epochs
  return model_vis
