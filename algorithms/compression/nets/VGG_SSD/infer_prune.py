...
def arg_parse():
    ...
    parser.add_argument('--save_dir', default='./prune0.2', help='The directory used to save the trained models', type=str)
...
def main():
    """
    The main function to infer the pruned model performance.
    ...
    # model.load_state_dict(torch.load(os.path.join(args.save_dir, 'model_pruned0.2_finetune_10.pth')))
