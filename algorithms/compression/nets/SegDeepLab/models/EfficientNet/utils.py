"""backbone_efficientnet_utils.py - Helper functions for building the model and for loading model parameters.
...
#
#         # self.conv = nn.Conv2d(weight=self.weight, bias=self.bias, stride=self.stride,
...
#     # With the same calculation as Conv2dDynamicSamePadding
#
#     def __init__(self, in_channels, out_channels, kernel_size, groups=1, stride=1, bias=True, image_size=None, **kwargs):
#         super().__init__()
#         self.conv = nn.Conv2d(in_channels, out_channels, kernel_size, groups=groups, stride=stride, bias=bias)
...
class Conv2dStaticSamePadding(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, groups=1, stride=1, bias=True, image_size=None, **kwargs):
        ...
        self.conv = nn.Conv2d(in_channels, out_channels, kernel_size, groups=groups,
                              stride=stride, bias=bias, padding=pad_h - pad_h // 2)
        # print('self.conv:', in_channels, out_channels, kernel_size, groups, self.stride, bias, pad_h)
...
def load_pretrained_weights(model, model_name, weights_path=None, load_fc=True, advprop=False):
    ...
    """
    # weights_path='/home/data1/zishunyao/seg_code/efficientnet-b0-355c32eb.pth'
