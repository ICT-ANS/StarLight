...
* The lightweight models generated by StarLight can be seamlessly deployed on edge devices such as [TensorRT](https://developer.nvidia.com/tensorrt), without the need for additional processing.
