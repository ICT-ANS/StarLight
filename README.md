...
* The lightweight models generated by StarLight can be seamlessly deployed on edge devices such as [NVIDIA AGX XAVIER](https://www.nvidia.com/en-us/autonomous-machines/embedded-systems/jetson-agx-xavier/), without the need for additional processing.
