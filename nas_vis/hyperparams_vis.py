...
from ui.qtui.nas.nas_hyperparams_ui import *
...
class HyperparametersSettingWindow(QDialog):
    ...
    def set_enable(self):   
        if self.method in ['BurgerFormer']:
    ...
    def reset(self):
        ...
        self.ui.lineEdit_8.setText("1e9")
        self.ui.lineEdit_9.setText("10e6")
    ...
    def get_data(self):
        ...
        data.append('target FLOPs：' + self.ui.lineEdit_8.text())
        data.append('target Params：' + self.ui.lineEdit_9.text())
        data.append('iteration：' + self.ui.lineEdit_10.text())
        return data
    ...
    def get_dict_data(self):
        ...
        data['target_flops'] = self.ui.lineEdit_8.text()
        data['target_params'] = self.ui.lineEdit_9.text()
        data['iteration'] = self.ui.lineEdit_10.text()
        return data
    ...
    def valid_check(self):
        ...
        data['target flops'] = self.ui.lineEdit_8.text()
        data['target params'] = self.ui.lineEdit_9.text()
        data['iteration'] = self.ui.lineEdit_10.text()
        # validity test
        for key in data:
            if key in ['classes', 'epochs', 'batch size', 'iteration']:
            ...
            elif key in ['learning rate', 'arch learning rate', 'target flops', 'target params']:
